...
def create_directory_hierarchy(): #TODO
    pass

def data_generation_func(root_dir, dataset, nVal):
    name = ''
...
## TODO creare funzione che crea la gerarchia delle cartelle cfr. https://github.com/gbouritsas/Neural3DMM
'''
...
def init_func():
    ...
    data_generation_func(args.root_dir, args.dataset, args.num_valid)
