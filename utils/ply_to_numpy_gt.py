"""
Funziona solo con il dataset COMA ad ora. Genera anche train e test per l'esperimento con il groundtruth 'forzato'.
"""
...
if __name__ == '__main__':
    ...
    # python. /utils/ply_to_numpy_gt.py --directory C:\Users\chiar\Desktop\COMA_data_noses_TOP
...
#
#     ### GT
#     print(f"Finish: shape of train is {complete_train_gt.shape} final shape is ")
#     complete_train_gt = complete_train_gt[1:, :, :]
#     print(complete_train_gt.shape)
#
#     print(f"Finish: shape of test is {complete_test_gt.shape} final shape is ")
#     complete_test_gt = complete_test_gt[1:, :, :]
#     print(complete_test_gt.shape)
#     ###
#
...
#         np.save(file, complete_test)
#
#     with open("train_nasi_gt.npy", 'wb') as file:
#         np.save(file, complete_train_gt)
#
#     with open("test_nasi_gt.npy", 'wb') as file:
#         np.save(file, complete_test_gt)
#
